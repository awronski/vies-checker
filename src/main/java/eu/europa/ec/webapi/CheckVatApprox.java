...
public class CheckVatApprox {
     ...
     * 
     */
    public CheckVatApprox(final String countryCode, final String vatNumber, final String traderName, final String traderCompanyType, final String traderStreet, final String traderPostcode, final String traderCity, final String requesterCountryCode, final String requesterVatNumber) {
