...
public class CheckVatApproxResponse {
     ...
     * 
     */
    public CheckVatApproxResponse(final String countryCode, final String vatNumber, final XMLGregorianCalendar requestDate, final boolean valid, final JAXBElement<String> traderName, final JAXBElement<String> traderCompanyType, final String traderAddress, final String traderStreet, final String traderPostcode, final String traderCity, final String traderNameMatch, final String traderCompanyTypeMatch, final String traderStreetMatch, final String traderPostcodeMatch, final String traderCityMatch, final String requestIdentifier) {
