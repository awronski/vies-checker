...
public class CheckVatResponse {
     ...
     * 
     */
    public CheckVatResponse(final String countryCode, final String vatNumber, final XMLGregorianCalendar requestDate, final boolean valid, final JAXBElement<String> name, final JAXBElement<String> address) {
